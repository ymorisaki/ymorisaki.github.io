...
(function (win, doc) {
  ...
  function () {
    ...
    _createClass(Scroll, [{
      ...
      value: function setObserver() {
        ...
        var setCallback = function setCallback(entries, object) {
          entries.forEach(function (entry) {
            if (!entry.isIntersecting) {
              return;
            }

            entry.target.classList.add(_this.addClassName);
        ...
        var observer = new IntersectionObserver(setCallback, options);
  ...
  win.addEventListener('load', function () {
    doc.querySelectorAll('.point-01').forEach(function (el) {
      new Scroll(el, {
        alternate: true
      });
    });
